...
SWEP.Primary.Damage = 2147483647 --The amount of damage will the weapon do
...
SWEP.Primary.Spread = 0.767 -- The spread when shot
SWEP.Primary.NumberofShots = 256 -- Number of bullets when shot
SWEP.Primary.Automatic = true -- Is it automatic
SWEP.Primary.Recoil = 0 -- The amount of recoil
SWEP.Primary.Delay = 0 -- Delay before the next shot
SWEP.Primary.Force = 2147483647
